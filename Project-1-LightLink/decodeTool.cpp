...
namespace decode {
    ...
    const int INFO_AREA_SIZE[10][4] = {
        {20, 180, 160, 340},     // 左上角区域 1
        {20, 520, 160, 350},     // 左上角区域 2
        {180, 20, 360, 520},     // 左侧区域 1
        {180, 540, 360, 520},    // 左侧区域 2
        {540, 20, 360, 520},     // 右侧区域 1
        {540, 540, 360, 520},    // 右侧区域 2
        {900, 180, 160, 360},    // 右下角区域 1
        {900, 540, 160, 360},    // 右下角区域 2
        {900, 900, 80, 160},     // 右下角小区域 1
        {980, 900, 80, 80}       // 右下角小区域 2
    };
